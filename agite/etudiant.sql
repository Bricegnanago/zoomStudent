...
-- Listage de la structure de la table agitel. etudiant
...
-- Listage des données de la table agitel.etudiant : ~24 rows (environ)
/*!40000 ALTER TABLE `etudiant` DISABLE KEYS */;
INSERT INTO `etudiant` (`code`, `nom`, `prenom`, `date_naissance`) VALUES
